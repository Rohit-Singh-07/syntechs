...
const CountdownTimer = () => {
  ...
  const TimeBox = ({ val, label }: { val: number; label: string }) => (
    <div className="flex flex-col items-center gap-0.5">
      ...
      >
        <AnimatePresence mode="popLayout">
          <motion.span
            ...
            style={{ color: "#ffcc00", textShadow: "0 0 6px rgba(255,190,0,0.5)" }}
      ...
      <span className="text-[8px] uppercase tracking-widest" style={{ color: "rgba(255,180,80,0.45)" }}>
        {label}
      </span>
    </div>
  );
  ...
  return (
    <div className="flex items-center gap-1.5 mt-2">
      ...
      <span className="text-sm font-bold pb-4" style={{ color: "rgba(255,140,0,0.4)" }}>:</span>
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-64 h-64 rounded-full opacity-10 blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, #ff1a8c, transparent 70%)" }} />
      <div className="absolute bottom-0 left-0 w-56 h-56 rounded-full opacity-8 blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, #00a8ff, transparent 70%)" }} />
      <div className="absolute bottom-0 right-0 w-56 h-56 rounded-full opacity-8 blur-3xl pointer-events-none"
        style={{ background: "radial-gradient(circle, #00cc66, transparent 70%)" }} />
      ...
      >
        ...
        <motion.div
          className="mt-5 flex items-center gap-4 px-5 py-3 rounded-xl animate-bounce"
          style={{
            background: "rgba(15, 8, 0, 0.75)",
            border: "1px solid rgba(255,160,0,0.28)",
            boxShadow: "0 0 24px rgba(255,120,0,0.1), 0 2px 12px rgba(0,0,0,0.4)",
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            <span
              ...
              style={{ color: "rgba(255,255,255,0.3)", textDecorationColor: "rgba(255,80,80,0.5)" }}
            >
              ₹249
            </span>
            <span
              className="text-3xl font-black leading-none animate-bounce"
              style={{ color: "#ffd166", textShadow: "0 0 14px rgba(255,200,0,0.4)", letterSpacing: "-0.03em" }}
            >
              ₹149
            </span>
            <div
              ...
              style={{
                background: "linear-gradient(135deg, rgba(255,80,0,0.25), rgba(255,20,100,0.2))",
                border: "1px solid rgba(255,80,0,0.3)",
              }}
            >
              <span className="text-sm font-black leading-none" style={{ color: "#ff6b00" }}>{pctOff}%</span>
              <span className="text-[7px] uppercase tracking-wide mt-0.5" style={{ color: "rgba(255,150,80,0.5)" }}>off</span>
            </div>
          </div>

          {/* Vertical divider */}
          <div className="w-px self-stretch rounded-full" style={{ background: "rgba(255,150,0,0.2)" }} />

          {/* Timer */}
          <div className="flex flex-col items-center gap-0.5">
            <p className="text-[9px] uppercase tracking-widest" style={{ color: "rgba(255,180,80,0.4)" }}>
              ends in
            </p>
            <CountdownTimer />
          </div>
